...
|
*/
// Make sure to set your URL in production mode.
$config['base_url'] = _guess_base_url(); // 'http://dev.example.com/skeleton/';
...
|
*/
$config['log_threshold'] = ('development' === ENVIRONMENT) ? 2 : 1;
...
| 'sess_namespace'
|
|	This setting is useful in case you run PHP native session library
|	instead of CodeIgniter's and you are using multiple applications
|	on the site site.
|
