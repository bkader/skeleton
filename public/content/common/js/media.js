...
(function ($, window, document, undefined) {
    ...
    $(document).ready(function () {
        ...
        $(document).on("hidden.bs.modal", "#media-modal", function (e) {
            ...
            var toURL = csk.config.currentURL;
            if (toURL.search(/item=/i) != -1) {
                toURL = csk.config.adminURL + "/media";
            }
            window.history.pushState({href: toURL}, "", toURL);
            $(this).remove();
        });
        ...
        $(document).on("click", btnSelectBulk, function (e) {
            ...
            $(btnSelectDelete).removeClass("hidden");
        ...
        $(document).on("click", btnSelectCancel, function (e) {
            ...
            $(btnSelectBulk).removeClass("hidden");
            $(".attachments")
