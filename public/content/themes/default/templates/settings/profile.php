<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-sm-pull-8 col-md-3 col-md-pull-9">
		<div class="list-group">
			<?= anchor('settings/profile', lang('set_profile_title'), 'class="list-group-item active"') ?>
		<?php if (get_option('use_gravatar', false) == false): ?>
			<?= anchor('settings/avatar', lang('set_avatar_title'), 'class="list-group-item"') ?>
		<?php endif; ?>
			<?= anchor('settings/password', lang('set_password_title'), 'class="list-group-item"') ?>
			<?= anchor('settings/email', lang('set_email_title'), 'class="list-group-item"') ?>
		</div>
	</div>
</div>
