<div class="row">
	<div class="col-xs-12 col-sm-6 col-sm-push-3 col-md-4 col-md-push-4">
		<h1 class="text-center"><?= __('us_resend_heading') ?></h1>
		<div class="panel panel-default">
			<div class="panel-body">
				<p class="text-muted"><?= __('us_resend_notice') ?></p><br />
				<?= form_open('register/resend', 'role="form" autocomplete="off"', @$hidden) ?>
				...
				<?php endif; ?>
					<button type="submit" class="btn btn-primary btn-block"><?= __('resend_link') ?></button>
				<?= form_close() ?>
			</div>
