<h2 class="page-header"><?= __('us_manage_users') ?> <?= admin_anchor('users', __('us_manage_users'), 'class="btn btn-primary btn-sm pull-right"') ?></h2>

<div class="row">
	<div class="col-md-4 col-md-offset-4">
		<div class="panel panel-default">
			<div class="panel-heading"><h3 class="panel-title"><?= __('add_user') ?></h3></div>
			<div class="panel-body">
				<?= form_open('admin/users/add', 'role="form"', @$hidden) ?>
					<fieldset>
						...
						<div class="form-group">
							<input type="checkbox" name="enabled" id="enabled" value="1" <?= set_checkbox('enabled', '1', true) ?>>&nbsp;<label for="enabled"><?= __('active') ?></label>
							<span class="pull-right">
								<input type="checkbox" name="admin" id="admin" value="1" <?= set_checkbox('admin', '1', false) ?>>&nbsp;<label for="admin"><?= __('admin') ?></label>
							</span>
						</div>

						<button type="submit" class="btn btn-primary btn-block"><?= __('add_user') ?></button>
					</fieldset>
				<?= form_close() ?>
			</div>
		</div>
