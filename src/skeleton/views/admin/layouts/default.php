	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><?php echo anchor('', __('view_site')) ?></li>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				<li<?php echo (get_the_module() == null) ? ' class="active"' : '' ?>><?php echo admin_anchor('', __('dashboard')) ?></li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<?php the_content(); ?>
			<div class="footer"><?php echo anchor('', get_option('site_name')) ?>. &copy; Copyright <?php echo date('Y') ?>. RT: <strong>{elapsed_time}</strong>. TT: <strong>{theme_time}</strong>.</div>
		</div>
	</div><!--/.row-->
</div><!--/.container-fluid-->
<?php the_alert(); ?>
